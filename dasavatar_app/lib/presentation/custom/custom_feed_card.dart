...
import 'package:dasavatar_app/presentation/location_page.dart';
          ...
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) => Location(
                        lat: double.parse(post.latitude),
                        long: double.parse(post.longitude),
                      )));
        }
      },
      child: Container(
        margin:
            EdgeInsets.symmetric(vertical: ScreenUtil.instance.setHeight(20)),
        child: Card(
          elevation: 5,
          child: Container(
